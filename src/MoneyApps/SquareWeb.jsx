  ...
  render() {
    return (
      <MoneyApp title="Square Cash Website" priority="medium">
        <div>If you don't want to sign up for a cash app, use this webpage to send me money using your debit card. Payments are sent <a href="https://cash.me/security">securely</a> by Square Cash.</div>
        <div>
